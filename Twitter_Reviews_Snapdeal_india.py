# -*- coding: utf-8 -*-
"""Copy of Twitter_Snapdeal_India.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1rNzYgLP3NVTQW5e5Gh672s-lJGvhqyir
"""
...
tweet_data = api_connect.search('Snapdeal India', count=10000, lang = "en", tweet_mode="extended")

#Print the last 5 Tweets fromt the account
print("Show the 5 recent tweets: \n")
i = 1
for tweet in tweet_data[0:100]:
...
wordcloud = WordCloud(background_color="white", random_state=21, max_words=300, max_font_size=119).generate(allWords)
